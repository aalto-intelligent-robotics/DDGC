...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            '--lambda_G_plane', type=float, default=20.0, help='')
        self.parser.add_argument(
        ...
        self.parser.add_argument('--no_plane_loss', action='store_true',
                                 help='if true, do not train with plane loss')
        self.parser.add_argument(
    ...
    def parse(self):
        ...
        self.opt.dataset_mode = "ycb_egad_cluttered_scenes_train"
